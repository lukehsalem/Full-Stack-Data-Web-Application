...
| --- | --- | --- |
| **Luke Salem** | [@lukehsalem](https://github.com/lukehsalem) | Analytics dashboard, Pandas aggregations, Chart.js integration, ORM Models, advanced error handling, retries, data loading, SSH tunneling, and CLI arguments for the data pipeline |
